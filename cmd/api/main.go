...
import (
	...
	"github.com/AHMED-D007A/Blogging-Platform-API/internal/database"
...
func main() {
	connStr := fmt.Sprintf("host=%v port=%v user=%v password=%v dbname=%v sslmode=disable",
		internal.Envs.DB_HOST, internal.Envs.DB_PORT,
		internal.Envs.DB_USERNAME, internal.Envs.DB_PASSWORD, internal.Envs.DB_NAME)
